...
PreparedStatement pst = null;
	...
	public UpdateRoom() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("pics/updateroom.jpg"));
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				conn c = new conn();
                            ...
                            try{
                                conn c  = new conn();
                                ResultSet rs2 = c.s.executeQuery("select * from room where roomno = '"+txt_Room.getText()+"'");
                                while(rs2.next()){
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) throws NumberFormatException {
				...
				try{
                                    conn c = new conn();
                                    String str = "update room set cleaning_status = '"+txt_Status.getText()+"' where roomno = "+txt_Room.getText();
