...
public class CheckOut extends JFrame{
	...
	public CheckOut() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("pics/checkout.jpg"));
		...
		contentPane.add(c1);
                ...
                ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("pics/tick.jpg"));
		...
		btnCheckOut.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String deleteSQL = "Delete from customer where number = '"+id+"'";
                                String q2 = "update room set availability = 'Available' where roomno = '"+s1+"'";
